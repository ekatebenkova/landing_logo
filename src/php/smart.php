<?php
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'ekat.tebenkova'; // Ваш логин в Яндексе. Именно логин, без @yandex.ru
    $mail->Password = 'gfhflbuvf'; // Ваш пароль
    $mail->SMTPSecure = 'ssl';
    $mail->Port = 465;
    $mail->setFrom('ekat.tebenkova@yandex.ru', 'Екатерина Тебенькова'); // Ваш Email с которого будет отправлятся и Имя отправителя
    $mail->addAddress('ekat.tebenkova@yandex.ru'); // Email получателя
